...
import { RemainingQuantityCell } from "./cells/remaining-quantity-cell.product";
import { KeyedMutator } from "swr";

export const inHistoryColumns = (mutate: KeyedMutator<ProductInHistory[]>) => {
  const columns: ColumnDef<ProductInHistory>[] = [
    {
    ...
    },
    {
      ...
      cell: ({ row }) => <RemainingQuantityCell mutate={mutate} row={row} />,
    },
    {
      accessorKey: "hpp",
      header: ({ column }) => (
